...
public:
	...
	void show_contact()
	{
		cout << endl << "Phone +27: " << phoneNumber;
		cout << endl << "Name: " << name;
...
void display_contact(int number)
{
	bool found;
	int ch;
...
int main(int argc, char *argv[])
{
	for (;;)
	{
		...
		switch (ch)
		{
		case 0: cout << "\n\n\t\tThank you for using Contact System...";
			break;
